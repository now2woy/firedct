...
@DynamicInsert
@DynamicUpdate
@Table(name = "DART_SAL_COST")
@IdClass(DartSalCostPrimaryKey.class)
public class DartSalCost implements Serializable {
	private static final long serialVersionUID = 2841692718827186047L;

...
public class ItmFincSts implements Serializable {
	 ...
	 * 매출총이익
	 */
	@Column(name = "SAL_TOT_INCM_AMT", nullable = true, length = 20)
	private BigDecimal salTotIncmAmt;
	
	/**
	 * 합계 매출총이익
	 */
	@Column(name = "ADD_SAL_TOT_INCM_AMT", nullable = true, length = 20)
	 ...
	 * F-SCORE 1
	 */
	@Column(name = "FSCR_FST", nullable = true)
	private String fscrFst;
	
	/**
	 * F-SCORE 2
	 */
	@Column(name = "FSCR_SND", nullable = true)
	private String fscrSnd;
	
	/**
	 * F-SCORE 3
	 */
	@Column(name = "FSCR_TRD", nullable = true)
